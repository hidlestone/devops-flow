...
## Nginx 
- [01-nginx安装部署](/doc/Nginx/01-nginx安装部署.md)
- [02-nginx基础](/doc/Nginx/02-nginx基础.md)
- [03-nginx的11个phases](/doc/Nginx/03-nginx的11个phases.md)
- [04-nginx高并发系统优化](/doc/Nginx/04-nginx高并发系统优化.md)
- [05-nginx陷阱和常见错误](/doc/Nginx/05-nginx陷阱和常见错误.md)
- [06-nginx配置节省带宽](/doc/Nginx/06-nginx配置节省带宽.md)
- [07-nginx配置文件nginx.conf详解](/doc/Nginx/07-nginx配置文件nginx.conf详解.md)
